<?php 
//Anonim fonksiyonlarin ismi olmaz
//Ama function keywordunu kullanmamiz gerekir
//Burdas bir degiskeni bir fonksiyon gibi kullanabiliyoruz.. 

$res=function(){
    echo "This is anonymus function";
};

$res();

$res2=function($number){return $number;};
echo $res2(32);


$res3=function($number2){$number2;};
//Biz burda anonim fonksiyonlari depoluyoruz aslinda
//Bu arada noktali virgun olayi php de cok onemlidir, kullanilmadigi yerde hataya sebep oluyor
$arr=[
    function(){return "first func";},
    function(){return "second func";},
    function(){return "third func";},

];

echo "</br>". "................" . "</br>" ;

print_r($arr);//Array ( [0] => Closure Object ( ) [1] => Closure Object ( ) [2] => Closure Object ( ) )


echo "</br>". "................" . "</br>" ;


echo $arr[1]();//second func
